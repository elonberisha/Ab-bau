...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (updateSectionData('hero_section', $data)) {
        $message = 'Seksioni Hero u përditësua me sukses!';
        $messageType = 'success';
    } else {
        $message = 'Ndodhi një gabim gjatë përditësimit.';
        $messageType = 'error';
    }
}
...
<head>
    ...
    <title>Menaxho Hero Section - Admin Panel</title>
                ...
                <form method="POST" class="space-y-6 max-w-5xl mx-auto">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100 flex items-center">
                            <i class="fas fa-edit mr-2 text-yellow-500"></i>Përmbajtja Kryesore
                        </h2>
                        
                        <div class="grid grid-cols-1 gap-6">
                            <!-- Title -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Titulli Kryesor</label>
                                <input type="text" name="title" value="<?php echo htmlspecialchars($hero['title'] ?? ''); ?>" 
                                       ...
                                       placeholder="psh. Ndërtojmë të Ardhmen">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="subtitle" rows="3" 
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
                                          placeholder="Përshkrim i shkurtër..."><?php echo htmlspecialchars($hero['subtitle'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100 flex items-center">
                            <i class="fas fa-image mr-2 text-blue-500"></i>Imazhi i Sfondit
                        </h2>
                        
                        <div class="flex flex-col md:flex-row gap-6 items-start">
                            <div class="flex-1 w-full">
                                <label class="block text-sm font-medium text-gray-700 mb-2">URL e Fotos</label>
                                <div class="flex gap-2">
                                    ...
                                    <button type="button" onclick="openMediaPicker('hero_image')" 
                                        ...
                                        <i class="fas fa-folder-open"></i> Zgjidh
                                    </button>
                                </div>
                                <p class="text-xs text-gray-500 mt-2">Zgjidhni një foto nga Media Library ose shkruani URL-në manualisht.</p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100 flex items-center">
                            <i class="fas fa-link mr-2 text-green-500"></i>Butonat
                        </h2>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Button 1 -->
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <h3 class="font-medium text-gray-700 mb-3 border-b border-gray-200 pb-2">Butoni Kryesor (Majtas)</h3>
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Teksti</label>
                                        <input type="text" name="button1_text" value="<?php echo htmlspecialchars($hero['button1_text'] ?? ''); ?>" 
                                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Linku</label>
                            ...
                            <!-- Button 2 -->
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                <h3 class="font-medium text-gray-700 mb-3 border-b border-gray-200 pb-2">Butoni Sekondar (Djathtas)</h3>
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Teksti</label>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100 flex items-center">
                            <i class="fas fa-chart-bar mr-2 text-purple-500"></i>Statistikat (Opsionale)
                        </h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="p-3 border border-gray-200 rounded-lg">
                                <div class="mb-2">
                                    <label class="block text-xs text-gray-500 mb-1">Numri 1</label>
                                ...
                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Teksti 1</label>
                            ...
                            <div class="p-3 border border-gray-200 rounded-lg">
                                <div class="mb-2">
                                    <label class="block text-xs text-gray-500 mb-1">Numri 2</label>
                                ...
                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Teksti 2</label>
                            ...
                            <div class="p-3 border border-gray-200 rounded-lg">
                                <div class="mb-2">
                                    <label class="block text-xs text-gray-500 mb-1">Numri 3</label>
                                    <input type="text" name="stat3_number" value="<?php echo htmlspecialchars($hero['stat3_number'] ?? ''); ?>" 
                                           class="w-full px-3 py-1.5 border border-gray-300 rounded text-sm">
                                </div>
                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Teksti 3</label>
